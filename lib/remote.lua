...
function snapshot()
    ...
    return {
        ...
        quarryPhase     = state.quarryPhase or "mine",
        dropChestsCount = state.dropChests and #state.dropChests or 0,
        surfaceFila     = state.surfaceFila or 0,
        awaitingResupply = state.awaitingResupply == true,
        -- swarm P2P health
